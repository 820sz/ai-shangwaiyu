...
## 状态
- 当前版本:**v2.0.0+54**(Release v2.0.0 = Latest;v2.0.0-preview.1/2/3 为过程预览版,已被正式版取代;上版 v1.9.1)
- 当前阶段:✅ **2.0 阶段一(v2.0 地基+导师+材料)已交付**;下一阶段 v2.1(FSRS 复习队列 UI / 错误档案 / 周报 / 每日提醒)已开工(调度内核与队列已落地)
- 状态协议:DONE(analyze 0 error/0 warning;505 测试全绿 +1 skip;APK 已发 Release;远端已同步)
