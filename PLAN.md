...
## 状态
- 当前版本:**v1.2.17**(commit cf69c90,Release 已发 = Latest,带 app-release.apk)
- 当前阶段:🔵 修复发布 → 待真机验证(重拍识别:词条完整 + 只两档思考)
- 状态协议:DONE_WITH_CONCERNS(词条截断已由 v1.2.16 提示词修复,实测 4 组 0 截断;待用户重新识别确认)
