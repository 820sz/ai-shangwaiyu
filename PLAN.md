...
## 状态
- 当前版本:**v2.3.3+60**(Release v2.3.3 = Latest;上版 v2.3.2)
- 当前阶段:🔧 **2.0 三阶段全部交付**,现处于"**整链路验证 + 真机反馈驱动修整**"期 —— v2.3.0 材料中心可用性/合并入口/底栏改名/删 AI 学习建议/桌面小组件;v2.3.1 诊断增强;v2.3.2 材料库三处真 bug;v2.3.3 生词去重 + 复习/听写链路测试。剩余仅「每日提醒」(需通知包,用户未定);**跟读按用户要求不再排期**
- 状态协议:IN_PROGRESS(等用户真机复测:材料库显示未读材料并点得开、听写收词不重复、小组件、诊断页;当前分支 analyze 0 error/0 warning、624 测试全绿 +1 skip、v2.3.3 已发 Release)
