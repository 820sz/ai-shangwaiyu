...
## 状态
- 当前版本:**v2.1.0+55**(Release v2.1.0 = Latest;上版 v2.0.0;v2.0.0-preview.1/2/3 为过程预览版已被取代)
- 当前阶段:🔧 **2.0 阶段二(v2.1 记忆与反馈)已交付**;阶段三(v2.2 听说与生产力)进行中 —— 听力播放与导出/备份已落地,剩逐句听写/跟读、桌面小组件、深色模式
- 状态协议:IN_PROGRESS(2.0 三阶段未全部交付;当前分支 analyze 0 error/0 warning、563 测试全绿 +1 skip、v2.1.0 已发 Release、远端已同步)
