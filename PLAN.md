...
## 状态
- 当前版本:**v2.2.0+56**(Release v2.2.0 = Latest;上版 v2.1.0;v2.0.0-preview.1/2/3 为过程预览版已被取代)
- 当前阶段:🔧 **2.0 阶段三(v2.2 听说与生产力)基本交付** —— 听力播放/听写/阅读包导出/深色模式已落地;剩**桌面小组件**(需原生+真机配合)、跟读(需 ASR)、每日提醒(通知包未获批)
- 状态协议:IN_PROGRESS(2.0 三阶段已交付可发版内容;当前分支 analyze 0 error/0 warning、588 测试全绿 +1 skip、v2.2.0 已发 Release)
