...
## 状态
- 当前版本:**v2.3.2+59**(Release v2.3.2 = Latest;上版 v2.3.1)
- 当前阶段:🔧 **2.0 三阶段全部交付**,现处于"**整链路验证 + 真机反馈驱动修整**"期。v2.3.0 修材料中心可用性/合并入口/底栏改名/删 AI 学习建议/桌面小组件;v2.3.1 诊断增强;v2.3.2 修材料库三处真 bug(入库未读不可见、条目 id 恒 0 点不开、快照读模型不降级)。剩余仅「每日提醒」(需通知包,用户未定);**跟读按用户要求不再排期**
- 状态协议:IN_PROGRESS(等用户真机复测:材料库能否显示未读材料并点开、材料中心可用性、桌面小组件、诊断页;当前分支 analyze 0 error/0 warning、618 测试全绿 +1 skip、v2.3.2 已发 Release)
