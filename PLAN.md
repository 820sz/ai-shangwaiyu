...
## 状态
- 当前版本:**v2.3.0+57**(Release v2.3.0 = Latest;上版 v2.2.0)
- 当前阶段:🔧 **2.0 三阶段全部交付**(v2.0 地基+导师+材料 → v2.1 记忆与反馈 → v2.2 听说与生产力 → v2.3 桌面小组件 + 材料中心可用性修复 + 结构整理);剩余仅「每日提醒」(需通知包,用户未选);**跟读按用户要求不再排期**
- 状态协议:IN_PROGRESS(等用户真机复测 v2.3.0 的四处改动:材料中心可用性、入口合并、底栏改名、桌面小组件;当前分支 analyze 0 error/0 warning、611 测试全绿 +1 skip、v2.3.0 已发 Release)
